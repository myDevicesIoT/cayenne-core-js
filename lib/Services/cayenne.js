class Cayenne {
   ...
   */
   ...
   deleteGroup(device_id, group_id) {
     ...
     return this.auth.send(this.service, 'DELETE', url, { payload });
   }
   ...
   createOrUpdateAttribute(device_id, group_id, attribute_id, payload) {
    ...
    if(attribute_id == null){
      ...
      url = `${this.url}/things/${device_id}/groups/${group_id}/${attribute_id}`;
    }
    return this.auth.send(this.service, 'PUT', url, { payload });
  }
  ...
  /**
    ...
    */
   deleteGroup(device_id, group_id, attribute_id) {
    const url = `/things/${device_id}/groups/${group_id}/${attribute_id}`;
    return this.auth.send(this.service, 'DELETE', url, { payload });
  }
