...
class Hermes extends Request {
  ...
  sendNotification(userId, payload) {
    ...
    return this.send(this.service, 'POST', path, { payload });
  }
  ...
  verify() {
    ...
    return this.send(this.service, 'POST', path, {});
  }
  ...
  getLogs(userId, query) {
    ...
    return this.send(this.service, 'GET', path, { query });
  }
  ...
  getEmailTemplates() {
    ...
    return this.send(this.service, 'GET', path);
  }
